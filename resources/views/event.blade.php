      ...
      <div class="lg:flex items-stretch md:mt-12 mt-8">
        <div class="lg:w-1/2">
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
            <div class="sm:w-1/2 relative">
              ...
              <img src="img/eventsatu.png" class="w-full hover:scale-105 duration-500" alt="eventsatu" />
            </div>
            <div class="sm:w-1/2 sm:mt-0 mt-4 relative">
              ...
              <img src="img/eventdua.png" class="w-full hover:scale-105 duration-500" alt="eventdua" />
            </div>
          </div>
          <div class="relative">
            <div>
            ...
            <img src="img/eventtujuh.png" alt="eventtujuh" class="w-full mt-8 md:mt-6 hidden sm:block hover:scale-105 duration-500" />
        ...
        <div class="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
          <div class="relative">
            ...
            <img src="img/eventempat.png" alt="eventempat" class="w-full sm:block hidden hover:scale-105 duration-500" />
          ...
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
            <div class="relative w-full">
              ...
              <img src="img/eventlima.png" class="w-full hover:scale-105 duration-500" alt="eventlima" />
            </div>
            <div class="relative w-full sm:mt-0 mt-4">
              ...
              <img src="img/eventenam.jpeg" class="w-full hover:scale-105 duration-500" alt="eventenam" />
            </div>
          </div>
        </div>
      </div>
