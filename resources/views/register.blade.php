...
<header class="bg-cream-medium shadow-md border-b-2 border-cream-medium">
    <div class="flex justify-between items-center py-2 px-5">
        ...
        <a href="#" class="px-2 py-2 bg-read-dark text-red-dark font-semibold font-semibold rounded-lg text-sm">Beranda</a>
        <a href="#" class="px-2 py-2 bg-read-dark text-red-dark font-semibold font-semibold rounded-lg text-sm">Riwayat Donor</a>
        <a href="#" class="px-2 py-2 bg-read-dark text-red-dark font-semibold font-semibold rounded-lg text-sm">Event</a>
        <a href="#" class="px-2 py-2 bg-read-dark text-red-dark font-semibold rounded-lg text-sm">Let's Read</a>
        <a href="#" class="px-2 py-2 bg-red-dark text-cream-medium hover:bg-cream-dark font-bold rounded-lg text-sm">Masuk</a>
        </div>
    </div>
</header>
