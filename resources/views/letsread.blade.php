...
<div class="mx-auto bg-cream-medium w-full h-screen w-full flex items-center justify-center px-8">
  <div class="flex flex-col w-full bg-cream-medium rounded shadow-lg sm:w-3/4 md:w-full lg:w-full">
    <div class="w-full h-screen bg-top bg-cover rounded-t">
    <img src="img/letsread.png" alt="" class="w-full h-screen">
</div>
    <div class="flex flex-col w-full md:flex-row">
        <div class="flex flex-row justify-around p-4 font-bold leading-none text-black uppercase bg-cream-dark rounded md:flex-col md:items-center md:justify-center md:w-1/4">
            <div class="md:text-3xl">Aug</div>
            <div class="md:text-6xl">20</div>
            <div class="md:text-xl">8 pm</div>
        </div>
